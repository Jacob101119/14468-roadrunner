...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double par0YTicks = -2600.3346549880735; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2692.6409592961195; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -182.2482347250447; // x position of the perpendicular encoder (in tick units)
    }
